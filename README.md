...
This connect4 bot is quite fast and I managed a good experience (-> not long wait times) with a search depth of 20. This
is on a quite powerful pc, but still. I think my algorithm is optimized enough to work on any machine with search
depth > 12. I managed to achieve the best results with a search depth of 16, any search depth 15 >= 16 <= 20 It couldn't
even go to a draw, one of the players would win pretty early on.
